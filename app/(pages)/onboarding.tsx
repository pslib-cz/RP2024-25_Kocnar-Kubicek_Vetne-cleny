...
export default function OnboardingScreen() {
  ...
  return (
    <SafeAreaView style={[AndroidSafeArea.AndroidSafeArea, { flex: 1, backgroundColor: '#101223' }]}>
      ...
      >
        <Introductions goToPage={goToPage} />
        <ProfileSetup
          bodyColor={bodyColor}
          trailColor={trailColor}
          selectedRocketIndex={selectedRocketIndex}
          setSelectedRocketIndex={setSelectedRocketIndex}
          onColorChangeComplete={onColorChangeComplete}
          modifiedRocketSvgs={modifiedRocketSvgs as never[]}
          setLocalName={setLocalName}
          localName={localName}
          goToPage={goToPage}
          rocketPickerVisible={rocketPickerVisible}
          setRocketPickerVisible={setRocketPickerVisible}
          currentPickingFor={currentPickingFor as never}
          setCurrentPickingFor={setCurrentPickingFor}
        />
        <ArenaInfo
          goToPage={goToPage}
          width={width}
...
const ProfileSetup = ({
  ...
  setSelectedRocketIndex = (index: number) => { },
  onColorChangeComplete = (color: string) => { },
  modifiedRocketSvgs = [],
  setLocalName = (name: string) => { },
  localName = '',
  goToPage = (idx: number) => { },
  rocketPickerVisible = false,
  setRocketPickerVisible = (visible: boolean) => { },
  currentPickingFor = null,
  setCurrentPickingFor = (type: 'body' | 'trail' | null) => { },
}) => {

...
export const MultiplayerGameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const resetGameState = () => {
    ...
    setConfig({
      ...
      seeded: true,
      questionCount: 10, // Default number of questions
      seed: undefined, // Seed will be generated by server when seeded is true
    });
    setPlayers([]);
    setAuthor(null);
    setSessionId(null);
  ...
  const joinGame = async (code: string) => {
    try {
      ...
      setConfig({
        ...
        seeded: response.game.seed !== null && response.game.seed !== undefined,
        seed: response.game.seed !== null ? response.game.seed : undefined,
